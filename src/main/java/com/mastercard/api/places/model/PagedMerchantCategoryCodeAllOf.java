 ...
 */
@ApiModel(description = "Paged response of Merchant Category Codes")
...
public class PagedMerchantCategoryCodeAllOf {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<MerchantCategoryCode> items = new ArrayList<MerchantCategoryCode>();


  public PagedMerchantCategoryCodeAllOf items(List<MerchantCategoryCode> items) {
    
    this.items = items;
    return this;
  }

  public PagedMerchantCategoryCodeAllOf addItemsItem(MerchantCategoryCode itemsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedMerchantCategoryCodeAllOf pagedMerchantCategoryCodeAllOf = (PagedMerchantCategoryCodeAllOf) o;
    return Objects.equals(this.items, pagedMerchantCategoryCodeAllOf.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedMerchantCategoryCodeAllOf {\n");
