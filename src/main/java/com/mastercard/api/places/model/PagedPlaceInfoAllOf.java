...
public class PagedPlaceInfoAllOf {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<PlaceInfo> items = new ArrayList<PlaceInfo>();


  public PagedPlaceInfoAllOf items(List<PlaceInfo> items) {
    
    this.items = items;
    return this;
  }

  public PagedPlaceInfoAllOf addItemsItem(PlaceInfo itemsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PagedPlaceInfoAllOf pagedPlaceInfoAllOf = (PagedPlaceInfoAllOf) o;
    return Objects.equals(this.items, pagedPlaceInfoAllOf.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedPlaceInfoAllOf {\n");
